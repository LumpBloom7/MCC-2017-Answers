...
%CD:~0,2%/Compilers/MinGW64_4.9.2/bin/rm.exe bin/Debug/Output64.exe bin/Debug/main.o
set start=%time%
...
%CD:~0,2%/Compilers/MingW64_4.9.2/bin/g++.exe -D__DEBUG__ bin/Debug/main.o -o bin/Debug/Output64.exe  -static-libgcc -pg -g3
)
set end=%time%
...
set file="bin/Debug/Output64.exe"
...
echo --------
if exist bin/Debug/Output64.exe (
    echo - Successful!
    echo - Output Filename: Output64.exe
